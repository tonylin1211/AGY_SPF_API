...
## 📊 測試環境與基本資訊
- **測試時間**：2026-05-27 17:38:13 (台灣台北時間, Asia/Taipei)
...
```
[2026-05-27 17:38:13.244] [INFO] =========================================
[2026-05-27 17:38:13.244] [INFO] 開始執行永豐 API 模擬環境交易功能測試...
[2026-05-27 17:38:13.244] [INFO] =========================================
[2026-05-27 17:38:13.244] [WARNING] 未設定交易憑證路徑 (SHIOAJI_CA_PATH) 或密碼 (SHIOAJI_CA_PASSWORD)。
[2026-05-27 17:38:13.244] [WARNING] 依據永豐規定，即使在模擬環境下單亦需憑證。將自動進入「模擬日誌模式」產生報告範本。
[2026-05-27 17:38:13.245] [INFO] 執行模擬數據生成，模擬登入、CA激活、下單、改價、刪單流程...
```
